...
def SVM(train_data,
    ...
    # YOUR CODE GOES HERE
    ski = svm.SVC()
    ski.fit(train_data,train_labels)
    train_predictions=ski.predict(test_data)
    ...
    """
    test_accuracy = calculate_accuracy(train_predictions, test_labels)
    ...
    ==========================================================================
    """
    precision,recall,f1 = calculate_metrics(train_predictions,test_labels)
    # YOUR CODE GOES HERE
...
if __name__ == '__main__':
    ...
    totalrecall=0;
    totalprecision=0;
    ''' print in <accuracy_val>, <precision_val>, <recall_val>, <F-1_val> format'''
    for i in range(0,len(accumulated_metrics)):
        totalf1 = totalf1 + accumulated_metrics[i][3]
        totalrecall = totalrecall + accumulated_metrics[i][2]
        totalprecision = totalprecision + accumulated_metrics[i][1]
        totalacc =totalacc + accumulated_metrics[i][0]

    print totalacc/len(accumulated_metrics),',',totalprecision/len(accumulated_metrics),',' ,totalrecall/len(accumulated_metrics),',', totalf1/len(accumulated_metrics)
